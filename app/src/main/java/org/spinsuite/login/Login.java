...
//        }
	...
	private void startSynchronization() {
		...
		//	Add Parameters
		//red1 -- note hard coded SyncValues passing for the one time only InitialLoad
		bundle.putString(SyncValues.KEY_SOAP_URL, SyncValues.getInitialUrl(url));
		bundle.putString(SyncValues.KEY_NAME_SPACE, "http://www.erpcya.com/");
		...
		bundle.putString(SyncValues.KEY_SOAP_ACTION, "http://www.erpcya.com/" + SyncValues.DEFAULT_METHOD);
