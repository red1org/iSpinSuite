...
import org.spinsuite.sync.SSLUtilities;
...
public class CommunicationSoap extends SoapObject {
	...
	public void init_envelope(){
		...
		// red1 -- m_Envelope.addMapping(m_NameSpace, "CommunicationSoap", new CommunicationSoap().getClass());
	}
	...
	public void call() throws IOException, XmlPullParserException{
		//red1 --- for testing to localhost via WiFI - set URL to local IP
		//SSLUtilities.trustAllHttpsCertificates();
		//SSLUtilities.trustAllHostnames();

		//m_Transport.debug=true;  red1 -- in HttpTransportSE.class line 65
		m_Transport.call(null, m_Envelope); //red1 getM_SoapAction() causes ERROR - The given SOAPAction http://idempiere.org/ADInterface/1_0/queryData does not match an operation (back from iDempiere server)
	}
